 ...
 * @author FDL
 */
public class KategoriPdfExport {
    public void export(List<Kategori> kategoriList) throws IOException {
        ...
        Cell<PDPage> cell = headerRow.createCell(80, "Daftar Kategori");
        ...
        cell.setAlign(HorizontalAlignment.CENTER);
        cell.setFontSize(15);
        cell = row.createCell(70, "Nama Kategori");
        cell.setAlign(HorizontalAlignment.CENTER);
        cell.setFontSize(15);
        ...
        for (Kategori kategori : kategoriList) {
            ...
            cell = row.createCell(70, kategori.getNamaKategori());
            cell.setFontSize(15);
            cell.setFontSize(15);
            no++;
        }

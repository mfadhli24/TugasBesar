...
public class KategoriFrame extends JFrame {
       ...
       public KategoriFrame(KategoriDao kategoriDao) {
              ...
              KategoriButtonSimpanActionListener actionListenerSimpan = new KategoriButtonSimpanActionListener(this,
                            kategoriDao);
              btnSimpan.addActionListener(actionListenerSimpan);

              // KategoriButtonHapusActionListener actionListenerHapus = new
              // KategoriButtonHapusActionListener(this, kategoriDao);
       ...
       public void populateTable(List<Kategori> kategoriList) {
              ...
              tableModel = new KategoriTableModel(kategoriList);
              // table.setModel((ButtonModel) tableModel);
       }
